...
<table class="table table-bordered text-center" id="dataTable">
    ...
    <tbody>
        <?php $nomor = 1; ?>
        <?php $ambil = $koneksi->query("SELECT * FROM rekam AS r JOIN pasien AS p ON r.id_pasien = p.id_pasien JOIN poli AS pol ON r.id_poli=pol.id") ?>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="menu.php?halaman=transaksi&id=<?php echo $tampil['id_rekam'] ?>" class="btn btn-info"> Buat
                    Resep </a>
                <!-- <a href="menu.php?halaman=buat_resep&id=<?php echo $tampil['id_rekam'] ?>" class="btn btn-info"> Buat
                    Resep </a> -->
                <?php endif ?>
